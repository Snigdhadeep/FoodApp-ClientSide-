...
public class FoodViewHolder2 extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public TextView txt_fooditem_name,txt_fooditem_price,txt_fooditem_discount,txt_discountedprice,txt_fooditem_unit;
    ...
    public FoodViewHolder2(View itemView) {
        ...
        txt_fooditem_unit=(TextView)itemView.findViewById(R.id.txt_fooditem_unit);
